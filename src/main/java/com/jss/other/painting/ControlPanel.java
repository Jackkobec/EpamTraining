...
public class ControlPanel extends JFrame {
    ...
    public ControlPanel(GraphicsMain graphicsMain) {
        super("Control");
        ...
        setLocation(graphicsMain.getX() - 202, graphicsMain.getY());
    ...
    private void addComponents(Container contentPane) {
        ...
        calculateButton.addActionListener(e -> {
            ...
            Point center = new Point(xCen, yCen);
            com.jss.inheritance.model.Circle circle = new com.jss.inheritance.model.Circle(center, rad);
